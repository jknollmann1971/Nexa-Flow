...
class NexaFlowCard extends HTMLElement {
  ...
  _buildStaticSVG() {
    ...
    // Dynamically resolve icon path from the current script location (works for both HACS and manual installs)
    const iconPath = new URL('./', import.meta.url).pathname.replace(/\/$/, '');
